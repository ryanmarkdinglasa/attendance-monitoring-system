...
<link href="../css/nav-button-custom.css" rel="stylesheet" media="screen">
 ...
 .con{
	...
	<div>
		<div class="nav">
			<h1 align="center "  style="font-size:40px;">Attendance Monitoring System</h1>
		</div>
			<h2 style="text-align: center;"><span id="tick2" class="pull-rigth" >
						...
						<div class="wow fadeInDown context "> 
								...
								<div class=""> 
									<ul class="list-group">
										...
										<li class="list-group-item text-right"><span class="pull-left">Name</span><label id="name" name='name'><?php echo $name?></label> </li>
										<li class="list-group-item text-right"><span class="pull-left">Course</span><label id="course" name='course'><?php echo $course?></label></li>
										<li class="list-group-item text-right"><span class="pull-left">Year</span><label id="year" name='year'><?php echo $year?></label> </li>
									</ul>  
