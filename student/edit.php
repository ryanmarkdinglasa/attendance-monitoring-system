...
<section id="feature" class="transparent-bg">
 ...
 -->
                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "ContactNo">Guardian's E-mail:</label>

                      <div class="col-md-8">
						<input class="form-control input-sm" id="guardianEmails" name="guardianEmails" placeholder=
                        "Guardian's E-mail" type="email" value="<?php echo $s_student->guardianEmail;?>" required autocomplete="off">
                      </div>
                    </div>
                  </div> 
