...
error_reporting(0);
	...
	//$conn = mysqli_connect("localhost", "root", "", "dbattendance") or  die("Connection failed: " . mysqli_connect_error());
    //$result = mysqli_query($conn, "SELECT * FROM tblstudent WHERE StudentID='");
                ...
                <div class="features ">
                      <div class="col-sm-3 wow fadeInDown">
                              ...
                              <div class="panel">            
								...
								<div id="img_profile" class="panel-body">
                                    <img title="profile image" id="imgprofile" class="img-hover"   src="<?php if($photo==''){echo '../images/user.jpg';} else{echo $photo;}?>">
                                </div> 
                                </a>
                                 </div>
                              <ul class="list-group">
                      ...
                      <div class="col-md-8"><h2>Student Information</h2></div>
                        ...
                        <tr>
                          ...
                          <tr>
							...
							<td><label>Guardian's E-mail :</label></td>
                            <td colspan="2"  >
                              <label><?php echo $res->guardianEmail; ?></label> 
                            </td> 
                          </tr>
                          <tr>
