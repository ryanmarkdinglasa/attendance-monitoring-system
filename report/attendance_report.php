        ...
        <div class="container"> 
          ...
          <form action="index.php?view=attendance" method="POST" >
			 ...
			 <div class="center wow fadeInDown"> 
              ...
              <label>Date :</label> 
               <input class="Search_date date_pickerfrom" placeholder="mm/dd/yyyy"size="11" value="<?php Date('m/d/Y') ?>" data-date="<?php Date('m/d/Y') ?>" data-date-format="yyyy-mm-dd" data-link-field="any" data-link-format="yyyy-mm-dd" type="text"   name="attenddate" id="datemask2">
                  <!-- <label>To :</label>
                  <input class="Search_date date_pickerfrom" size="11" 
                   ...
                   <select name="Attendance"  class="Search_partylist Attendance"> 
                    ...
                    <button class="btn btn-primary" type="submit" id="search_attendance" style="margin-top:-3px;" ><i class="fa fa-go">GO</i></button> 
                </div>
            </div>
