                                  ...
                                  <div class="col-md-8">
                                    <input name="deptid" type="hidden" value="">
                                     <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                                       ...
                                       <div id="errormsg_username" style="background:none;color:red;" ></div>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div class="col-md-8">
                                    <input name="deptid" type="hidden" value="">
                                     <input class="form-control input-sm" id="U_PASS" name="U_PASS" placeholder=
                                       ...
                                       <div id="errormsg_pass1" style="background-color:none;color:red;"></div>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div class="col-md-8">
                                    <input name="deptid" type="hidden" value="">
                                     <input class="form-control input-sm RU_PASS" id="RU_PASS" name="RU_PASS" placeholder=
                                       ...
                                       <div id="errormsg_pass2" style="background:none;color:red;"></div>
                                       <!-- <div id="errormsg"></div> -->
                                  </div>
                                </div>
                              </div>
