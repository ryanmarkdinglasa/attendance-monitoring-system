                ...
                <div class="features">
                    ...
                    <form class="form-horizontal span6 wow fadeInDown" action="controller.php?action=edit" method="POST"> 
                       ...
                       type="Hidden" value="<?php echo $singledepartment->DepartmentID; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                            ...
                            <div class="col-md-8">
                              <input name="deptid" type="hidden" value="">
                               <input class="form-control input-sm" id="DEPARTMENT_NAME" name="DEPARTMENT_NAME" placeholder=
                                  "Department Name" type="text" value="<?php echo $singledepartment->Department; ?>" autocomplete="off" required>
                        ...
                        <div class="form-group">
                          ...
                          "Description" type="text" rows="6" onkeyup="javascript:capitalize(this.id, this.value);" required><?php echo $singledepartment->Description; ?></textarea>
                    ...
                    <div class="form-group">
                          <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                               <button class="btn btn-primary dsave" name="save" type="submit" ><span class="fa fa-save fw-fa"></span> Save</button>
